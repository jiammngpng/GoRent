...
class GoRentRentingView(View):
	...
	def post (self, request):
		...
		if json_data["ajaxAction"] == "SpaceRegister":
			print("maw")
			print(json_data)
			...
			classObj = GoRentRegisterSpace(firstname, lastname, coordinates, address, price)
			classObj.registerSpace()

		# elif json_data["ajaxAction"] == "AddRoommate":
		# 	print("maw")
		# 	print(json_data)
		# 	print(json_data['firstname'])
		# 	print(json_data['lastname'])
		# 	print(json_data['contactnumber'])

		# 	firstname = request.POST.get("firstname")
		# 	lastname = request.POST.get("lastname")
		# 	contactnumber = request.POST.get("contactnumber")

		# 	addRoommate = GoRentRegisterSpace()
