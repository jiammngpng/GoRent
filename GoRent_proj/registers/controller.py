...
class GoRentRegisterSpace():
    ...
    def __init__(self,firstname, lastname, coordinates, address, price):
    ...
    def addRoommates(self, firstname, lastname, contactnumber):
        roommates = SpaceRoommates(firstname = firstname, lastname = lastname, contactnumber = contactnumber)
        roommates.save()
